...
use SimpleSAML\WebServices\Security\XML\wsse\AbstractBinarySecurityTokenType;
...
final class BinarySecurityTokenTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wsse/BinarySecurityToken.xml',
        );
    }
    ...
    public function testMarshalling(): void
    {
        ...
        $actualXml = strval($binarySecurityToken);
