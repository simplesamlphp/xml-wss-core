...
/**
 * Class representing the SignatureConfirmation element
 *
 * @package simplesamlphp/xml-wss-core
 */
final class SignatureConfirmation extends AbstractSignatureConfirmation implements SchemaValidatableElementInterface
{
    ...
    public static function fromXML(DOMElement $xml): static
    {
        ...
        return new static(
            self::getAttribute($xml, 'Value', Base64BinaryValue::class),
            $Id,
        );
    }
}
